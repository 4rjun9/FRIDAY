...
async def promote(promt):
    ...
    try:
        ...
        await promt.edit("`𝐏𝐫𝐨𝐦𝐨𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲! 𝐍𝐨𝐰 𝐆𝐢𝐯𝐞 𝐏𝐚𝐫𝐭𝐲`")
...
async def nothanos(unbon):
    ...
    try:
        ...
        await unbon.edit("𝐔𝐧𝐛𝐚𝐧𝐧𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲. 𝐆𝐫𝐚𝐧𝐭𝐢𝐧𝐠 𝐚𝐧𝐨𝐭𝐡𝐞𝐫 𝐜𝐡𝐚𝐧𝐜𝐞.")
...
async def unmoot(unmot):
    ...
    if unmute(unmot.chat_id, user.id) is False:
        ...
        try:
            ...
            await unmot.edit("𝐮𝐧𝐦𝐮𝐭𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲")
        except UserIdInvalidError:
...
async def pin(msg):
    ...
    await msg.edit("𝐏𝐢𝐧𝐧𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲.")
